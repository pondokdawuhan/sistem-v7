...
@section('container')
  <div class=" overflow-x-auto shadow-md sm:rounded-lg bg-white p-5 rounded-md dark:bg-slate-900">
      ...
      <form action="">
        <div class="flex flex-wrap lg:flex-nowrap gap-3">
          <div class="flex flex-col w-full lg:w-min gap-2">
            ...
            <select name="kamar" id="kamar" class="px-3 py-1 rounded-md">
          ...
          <div class="flex flex-col w-full lg:w-min gap-2">
            ...
            <input type="text" name="kegiatan" id="kegiatan" class="px-3 py-1 rounded-md"
    ...
    @isset($santris)
      <form action="/presensiAsrama" method="POST">
        @csrf
        <input type="hidden" name="kamar_id" value="{{ request('kamar') }}">
