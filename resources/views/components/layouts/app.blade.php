...
<head>
  ...
  <title>{{ $title ?? 'Sistem Informasi Terpadu PPBM' }} | Sistem Informasi PPBM</title>
  <!--     Fonts and icons     -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/072de9b2aa.js" crossorigin="anonymous"></script>
...
<body>
  ...
  <main class="p-4 sm:ml-64 min-h-screen relative" x-data="{ modalOpen: false }">
    <div
      ...
      <h1 class="dark:text-white lg:text-xl mb-4 font-bold">{{ $title ?? 'Sistem Informasi Terpadu PPBM' }}</h1>
      {{ $slot }}
    </div>
  </main>
  ...
  <div id="myModal" tabindex="-1" aria-hidden="true"
    class="fixed top-0 left-0 right-0 z-50 bg-slate-500/70 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
