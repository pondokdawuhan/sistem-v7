          ...
          @foreach ($izins as $izin)
            <tr
              ...
              <td class="px-6 py-4"><a
                  href="/detailIzinPulangSantri/{{ $izin->santri->username }}">{{ $izin->santri->name }}</a>
              </td>
