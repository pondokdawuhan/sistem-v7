...
@section('container')
  <div class=" overflow-x-auto shadow-md sm:rounded-lg">
    ...
    <div class="flex items-center gap-2 mb-2">
      ...
      <a href="/penguranganPoin/create" class="bg-green-500 text-white px-3 py-1 rounded-md mb-2 inline-block">Tambah</a>
          ...
          <tr
            ...
            <td class="px-6 py-4">
              ...
              <i class="toggleDeleteModal mt-2 fa-solid fa-trash text-white bg-red-500 rounded-lg text-xs px-3 py-1 inline-block cursor-pointer"
                ...
                data-title="Apakah Anda yakin menghapus pengurangan ini?" data-url="{{ request()->path() }}"
                data-id="{{ $pengurangan->id }}"></i>
            </td>
          </tr>
        @endforeach
      </tbody>
