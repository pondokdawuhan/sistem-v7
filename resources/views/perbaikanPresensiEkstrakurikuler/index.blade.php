      ...
      <tbody>
        @foreach ($presensis as $presensi)
          <tr
            ...
            <td class="px-6 py-4">{{ $presensi->ekstrakurikuler->name }}</td>
            ...
            <td class="px-6 py-4">
              ...
              <i class="toggleMyModal fa-solid fa-edit text-white bg-sky-500 rounded-lg text-xs px-3 py-1 inline-block cursor-pointer mb-2"
                data-modal-target="myModal" data-modal-toggle="myModal" data-modal="perbaikanPresensi"
                data-title="Edit {{ $title }}" data-data="{{ $presensi }}"
                data-url="perbaikanPresensiEkstrakurikuler"></i>
              ...
              <i class="toggleDeleteModal mt-2 fa-solid fa-trash text-white bg-red-500 rounded-lg text-xs px-3 py-1 inline-block cursor-pointer"
                ...
                data-title="Apakah Anda yakin menghapus presensi ini?" data-url="presensiEkstrakurikuler/delete"
