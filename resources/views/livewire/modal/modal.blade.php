<div wire:ignore.self id="myModal" tabindex="-1" x-data="{ modalOpen: false }" x-show="modalOpen" aria-hidden="true"
  class="d-block top-0 left-0 right-0 z-50 bg-slate-500/70 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
