<div class=" overflow-x-hidden shadow-md sm:rounded-lg" x-data="{ openModal: false }">
  ...
  @endif
  <a wire:navigate href="/{{ $lembaga }}/{{ $role }}/pembinaanSantri/create"
        ...
        @foreach ($pembinaans as $pembinaan)
          <tr
            ...
            <td class="px-6 py-4"><a wire:navigate
                href="/{{ $lembaga }}/{{ $role }}/pembinaanSantri/detail/{{ $pembinaan->santri->username }}">{{ $pembinaan->santri->name }}</a>
            </td>
            ...
            <td class="px-6 py-4">
              <a wire:navigate
                href="/{{ $lembaga }}/{{ $role }}/pembinaanSantri/{{ $pembinaan->id }}/edit"
              ...
              <button class="px-3 py-1 rounded-md bg-red-500 text-white text-xs"
                wire:click='delete({{ $pembinaan->id }})'
                wire:confirm='Apakah Anda yakin menghapus pembinaan ini?'>Hapus</button>
            </td>
          </tr>
        @endforeach
      </tbody>
