            ...
            <tbody>
              @foreach ($pelajarans as $pelajaran)
                <tr
                  ...
                  <td class="px-6 py-4">{{ $pelajaran->nama }} </td>

                  <td class="px-6 py-4">

                    <button wire:click='delete({{ $pelajaran->id }})'
      ...
      <div class="lg:mt-10 flex flex-col gap-4">
        <div class="w-full">
          <div
            ...
            <h3 class="dark:text-white mb-2 border-b">Tambah Pelajaran</h3>
        ...
        <div class="w-full">
          <div
            class="w-full p-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <h3 class="dark:text-white mb-2 border-b">Edit Pelajaran</h3>
            <form wire:submit.prevent='edit'>
              <div class="flex gap-2 flex-col">
                <div class="flex flex-col gap-2">
                  <label for="" class="dark:text-white">Nama Pelajaran Lama</label>
                  <select wire:model='pelajaran_id' class="px-3 py-1 rounded-md dark:bg-slate-800 dark:text-white">
                ...
                <div class="flex flex-col gap-2">
                  <label for="" class="dark:text-white">Nama Pelajaran Baru</label>
