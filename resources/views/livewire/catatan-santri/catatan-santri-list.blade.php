<div class=" overflow-x-hidden shadow-md sm:rounded-lg">
  ...
  @endif
  <a wire:navigate href="/{{ $lembaga }}/{{ $role }}/catatanSantri/create"
        ...
        @foreach ($catatans as $catatan)
          <tr
            ...
            <td class="px-6 py-4"><a wire:navigate
                href="/{{ $lembaga }}/{{ $role }}/catatanSantri/detail/{{ $catatan->santri->username }}">{{ $catatan->santri->name }}</a>
            </td>
            ...
            <td class="px-6 py-4">
              <a wire:navigate href="/{{ $lembaga }}/{{ $role }}/catatanSantri/{{ $catatan->id }}/edit"
