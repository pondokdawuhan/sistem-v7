    ...
    <div class="bg-white dark:bg-slate-800 shadow-xl rounded-lg py-3">
      ...
      <div class="p-2">
            ...
            <table class="text-sm my-3 text-slate-900 dark:text-white">
              <tbody>
                @foreach ($user->kelasMengajar as $kelas)
                  <tr>
                    <td>{{ $kelas->nama }} {{ $kelas->lembaga->nama }}</td>
                  </tr>
                @endforeach
            ...
            <table class="text-sm my-3 text-slate-900 dark:text-white">
              <tbody>
                @foreach ($user->pelajaran as $pelajaran)
                  <tr>
                    <td>{{ $pelajaran->nama }} {{ $pelajaran->lembaga->nama }}</td>
                  </tr>
                @endforeach
        ...
        <div class="text-center my-3">
          <a class="bg-slate-700 text-white px-3 py-1 rounded-md font-medium" href="/user" wire:navigate>Kembali</a>
        </div>
