            ...
            <tbody>
              @foreach ($ekstrakurikulers as $ekstra)
                <tr
                  ...
                  <td class="px-6 py-4">{{ $ekstra->nama }} </td>
                  <td class="px-6 py-4">{{ $ekstra->user->name ?? '' }}</td>
                  <td class="px-6 py-4">{{ $ekstra->santri->count() ?? 0 }}</td>

                  <td class="px-6 py-4">
                    <a wire:navigate href="/ekstra/editRombel/{{ $ekstra->id }}"
      ...
      <div class="lg:mt-10 flex flex-col gap-4">
            ...
            <form wire:submit.prevent='edit'>
              <div class="flex gap-2 flex-col">
                <div class="flex flex-col gap-2">
                  ...
                  <select wire:model='ekstra_id' class="px-3 py-1 rounded-md dark:bg-slate-800 dark:text-white">
                    <option value="">pilih</option>
                    @foreach ($ekstrakurikulers as $kls)
        ...
        <div class="w-full">
          <div
            ...
            <form wire:submit.prevent='editPengampu'>
              <div class="flex gap-2 flex-col">
                <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-col gap-2">
                  ...
                  <select name="" id="" wire:model='pengampu'
