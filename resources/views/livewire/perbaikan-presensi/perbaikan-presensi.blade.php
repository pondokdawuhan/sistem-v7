          ...
          <form wire:submit.prevent='ubah'>
            @isset($pelajaran)
              <div class="dark:bg-slate-900 p-5 rounded-md">
                ...
                <div class="flex flex-col gap-2 mb-2">
                  <label class="dark:text-white" for="">Pelajaran</label>
                  <input type="text" class="px-3 py-1 rounded-md dark:bg-slate-800 dark:text-white"
                    wire:model='pelajaran' readonly>
                </div>
                <div class="flex flex-col gap-2 mb-2">
                  <label class="dark:text-white" for="">Jam</label>
                  <input type="text" class="px-3 py-1 rounded-md dark:bg-slate-800 dark:text-white" wire:model='jam'
                    readonly>
                </div>
                <div class="flex flex-col gap-2 mb-2">
