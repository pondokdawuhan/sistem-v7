<div class="p-5 rounded-md bg-white text-slate-800 dark:bg-slate-900 dark:text-white" x-data="{ openModal: false }">
          ...
          <form wire:submit.prevent='ubah'>
            @isset($presensi)
              <div class="dark:bg-slate-900 p-5 rounded-md">
                ...
                <div class="flex flex-col gap-2 mb-2">
                  <label class="dark:text-white" for="">Waktu</label>
                  <input type="text" class="px-3 py-1 rounded-md dark:bg-slate-800 dark:text-white" wire:model='waktu'
                    readonly>
                </div>
