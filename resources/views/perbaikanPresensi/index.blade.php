          ...
          <tr
            ...
            <td class="px-6 py-4">
              ...
              <i class="toggleMyModal fa-solid fa-edit text-white bg-sky-500 rounded-lg text-xs px-3 py-1 inline-block cursor-pointer mb-2"
                ...
                data-title="Edit {{ $title }}" data-data="{{ $presensi }}" data-for="santri"
                data-lembaga="{{ request('lembaga') }}" data-url="{{ $urls[0] }}/{{ $urls[1] }}"></i>
              ...
              <i class="toggleDeleteModal mt-2 fa-solid fa-trash text-white bg-red-500 rounded-lg text-xs px-3 py-1 inline-block cursor-pointer"
                ...
                data-title="Apakah Anda yakin menghapus presensi ini?"
                data-url="presensi/delete/{{ request('lembaga') }}" data-id="{{ $presensi->id }}"></i>
            </td>
          </tr>
        @endforeach
      </tbody>
