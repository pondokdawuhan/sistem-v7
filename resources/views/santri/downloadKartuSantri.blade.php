...
<body>
  <div class="w-[8.5cm] h-[5.5cm] border border-slate-300 rounded-md overflow-hidden relative" id="capture"
    ...
    <img src="/assets/images/kts.png" alt="bg" class="w-full absolute h-full">
    ...
    <div class="absolute left-[2.8cm] top-28 pr-3">
      <table class="text-[7px] font-bold">
        ...
        <tr>
          <td class="text-[8px]">JK</td>
          <td class="text-[8px]">: {{ $santri->dataSantri->jenis_kelamin }}</td>
        </tr>
        <tr>
