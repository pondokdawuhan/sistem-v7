...
<head>
  ...
  <title>404 | Sistem Informasi PPBM</title>
...
<body>
  <div class="text-center p-6 bg-white rounded-lg shadow-lg min-h-screen flex flex-col justify-center items-center">
    <div class="">
      ...
      <p class="text-2xl mt-2 text-gray-600 font-bold">Halaman yang Anda cari tidak ditemukan.</p>
      <p class="mt-4 text-lg text-gray-500">Mungkin halaman ini telah dihapus atau alamat URL yang Anda masukkan salah.
      </p>
