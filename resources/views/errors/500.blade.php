...
<head>
  ...
  <title>500 | Sistem Informasi PPBM</title>
...
<body>
  <div class="text-center p-6 bg-white rounded-lg shadow-lg min-h-screen flex flex-col justify-center items-center">
    <div class="">
      ...
      <h1 class="text-8xl font-extrabold text-gray-800">500</h1>
      <p class="text-2xl mt-2 text-gray-600 font-bold">Internal Server Error</p>
      <p class="mt-4 text-lg text-gray-500">Mohon Maaf Server Masih Terkendala, silakan coba lagi dalam beberapa saat
        atau hubungi admin</p>
